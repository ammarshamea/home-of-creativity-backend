...
class RequestRevision
{
    ...
    public function handle(ServiceRequest $request, string $reason): ServiceRequest
    {
        $updated = DB::transaction(function () use ($request, $reason): ServiceRequest {
        ...
        app(SyncClickUpFromStaff::class)->handle($updated, ClickUpSyncEvent::Revision, null, $reason);
